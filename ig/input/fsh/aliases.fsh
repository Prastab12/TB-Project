...
// ── FHIR measure terminology ──────────────────────────────────────────────────
Alias: $MeasurePopType  = http://terminology.hl7.org/CodeSystem/measure-population
Alias: $MeasureScoring  = http://terminology.hl7.org/CodeSystem/measure-scoring
Alias: $ImpNotation     = http://terminology.hl7.org/CodeSystem/measure-improvement-notation
