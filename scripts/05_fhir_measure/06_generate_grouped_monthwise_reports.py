...
def main():
    ...
    for idx, row in df_ktm.iterrows():
        ...
        # Create a unique month-wise folder, e.g. 2078-shrawan
        ...
        # Build individual MeasureReports for Kathmandu inside this month's folder
        for meas_id, spec in indicators_spec.items():
            ...
            # Determine if this specific month/indicator is flagged with DataAbsentReason
            ...
            # Build populations list with DataAbsentReason extensions where appropriate
            populations = []
            ...
            populations.append(num_pop)
            
            # Measure score object
            measure_score_obj = {
            ...
            # Save MeasureReport inside its monthwise folder
        ...
        # Create a Specific Bundle file inside this folder
